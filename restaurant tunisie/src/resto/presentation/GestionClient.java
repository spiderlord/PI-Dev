...
/**
    ...
    //Date dc=(Date)myDate;
        ...
        if (jButton3.getText().equals("Modifier")) {
            ...
            aut.setId(n);
            aut.setLogin(login.getText());
            aut.setPassword(motdp.getText());
            aut.setId_utilisateur(m);
            clientDao.updateClient(c,aut);
            MyModelList list = new MyModelList();//rafraichissement de la table
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            ...
            for (int i = 0; i < tbclient.getRowCount(); i++) {
                Boolean b = (Boolean) tbclient.getValueAt(i, 8);
